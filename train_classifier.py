        ...
        if cross_fold_validation is False:
            ...
            if generate_roc_curves:
                if feature_type == 'rwe':
                    ...
                    suffix = "gist"
                ml.plot_roc_curves(y_test, y_pred, filename="cnn_{0}.png".format(suffix))
        else:
            ...
            if generate_roc_curves:
                ...
                for fold in range(cfv_groups):
                    ...
                    ml.plot_roc_curves(y_test, y_pred, fold+1,
        ...
        if cross_fold_validation is False:
            ...
            if generate_roc_curves:
                if feature_type == 'rwe':
                    ...
                    suffix = "gist"
                ml.plot_roc_curves(y_test, y_pred, filename="ann_{0}.png".format(suffix))
        else:
            # Cross Fold Validation
            start_time = time.time()
            mean, variance, classifiers, accuracies = ml.cross_fold_validation(X_train, y_train,
        ...
        if cross_fold_validation is False:
            ...
            if generate_roc_curves:
                if feature_type == 'rwe':
                    ...
                    suffix = "gist"
                ml.plot_roc_curves(y_test, y_pred,
